  ...
  return (
    <>
      ...
      <article className="prose lg:prose-xl mx-auto py-40 px-4">
        ...
        <p>
          By accessing and using tryrewrite.com (the Service) and any other
          site, application, API or embedded content owned or operated by us,
          you accept and agree to be bound by the following terms and
          conditions:
        </p>
        <h2>Account Terms</h2>
        <ol>
          ...
          <li>
            You may not use the Services for any purpose outlined in our Use
            Restrictions policy.
          </li>
          <li>
        ...
        <ol>
          ...
          <li>
            We issue refunds for digital products within 14 days of the original
        ...
        <p>
          You agree that we own all of the intellectual property rights in the
          Service. You grant us a non-exclusive, royalty-free, irrevocable,
          perpetual and sub-licensable right to use, reproduce, distribute and
          display (including for commercial purposes) on the Service and in
          other media any content or material that you post on the Service, and
          any name(s) and/or avatar under which you post such content. Other
          than this right, we claim no intellectual property rights in relation
          to the information or content that you upload onto the Service.
        </p>
      </article>
    </>
  );
